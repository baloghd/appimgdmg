...
class MainWindow(Adw.ApplicationWindow):
    ...
    def _on_drag_prepare(self, source, x, y):
        ...
        content = Gdk.ContentProvider.new_for_bytes(
            "text/uri-list", GLib.Bytes.new(uri.encode())
        )
        return content
    ...
    def load_appimage(self, file_path: str):
        ...
        try:
            ...
            self.instructions.set_text(
                "Drag the app icon to the Applications folder to install"
            )
    ...
    def _install_appimage(self):
        ...
        try:
            installer = AppImageInstaller(
                ...
                install_dir=self.settings.get_install_directory_path(),
            )
            ...
            if installed_app:
                ...
                self.notifications.show_install_success(
                    self.current_info.name, str(installed_app.install_path)
                )
